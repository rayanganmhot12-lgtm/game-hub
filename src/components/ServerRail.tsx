...
export default function ServerRail({
  ...
  return (
    <>
      <aside className="sticky top-16 hidden h-[calc(100vh-4rem)] w-[72px] shrink-0 flex-col items-center gap-2 overflow-y-auto border-r border-border/60 bg-surface/60 py-3 backdrop-blur-xl md:flex">
        <Link
          href="/friends"
          title="Community"
